...
```{r, echo=FALSE}
include_graphics("Bilder/First_repo.png")
```
...
```{r, echo=FALSE}
include_graphics("Bilder/git-layout.png")
```
...
```{r, echo=FALSE}
include_graphics("Bilder/RTutor_git.png")
```   
.small[Quelle: https://rafalab.github.io/dsbook/git.html]
...
```{r, echo=FALSE}
include_graphics("Bilder/git-clone.png")
```
.small[Quelle: https://rafalab.github.io/dsbook/git.html]
...
```{r, echo=FALSE}
include_graphics("Bilder/git-status.png")
```
.small[Quelle: https://rafalab.github.io/dsbook/git.html]
...
```{r, echo=FALSE}
include_graphics("Bilder/git-add.png")
```
.small[Quelle: https://rafalab.github.io/dsbook/git.html]
...
```{r, echo=FALSE}
include_graphics("Bilder/git-commit.png")
```
.small[Quelle: https://rafalab.github.io/dsbook/git.html]
...
```{r, echo=FALSE}
include_graphics("Bilder/git-push.png")
```
.small[Quelle: https://rafalab.github.io/dsbook/git.html]
...
```{r, echo=FALSE}
include_graphics("Bilder/git-pull.png")
```
.small[Quelle: https://rafalab.github.io/dsbook/git.html]
...
```{r, echo=FALSE}
include_graphics("Bilder/Github-Testrepo.png")
```

---

```{r, echo=FALSE}
include_graphics("Bilder/Github-Testrepo2.png")
```
...
```{r, echo=FALSE}
include_graphics("Bilder/First_Repo_git.png")
```
...
```{r, echo=FALSE}
include_graphics("Bilder/Files-git.png")
```
...
include_graphics("Bilder/Erste_Pakete.png")
```
...
```{r, echo=FALSE, out.width='100%'}
include_graphics("Bilder/RStudio_git_add.png")
```
...
```{r, echo=FALSE}
include_graphics("Bilder/RStudio_git_commit.png")
```

--

```{r, echo=FALSE}
include_graphics("Bilder/RStudio_git_commit2.png")
```
...
```{r, echo=FALSE}
include_graphics("Bilder/RStudio_git_push.png")
```
...
```{r, echo=FALSE}
include_graphics("Bilder/RStudio_git_new.png")
```
