...
In unserem Interaktionsmodell (Spalte 2) erhalten wir genau die gleiche Arbeitslosenquote wie im Sample Split für Ostdeutschland: Hierfür müssen wir die Dummy Variable `ost` und die Konstante aufaddieren: `ost1 + Constant` = `3.82 + 3.12` = `6.94`!
