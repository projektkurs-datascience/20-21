...
```{r}
knitr::include_url("slides/Advance_RMarkdown.html")
```

Hervorragende Einführungen und Übersichten zu R Markdown bietet Allison Hill an.
[Hier](https://apreshill.github.io/rmd4cdc/#1) und [hier](https://rstudio-education.github.io/teaching-in-production/slides/index.html#1) finden Sie zwei sehr gute Präsentationen.
...
### 02: Zweiter Teil der Case-Study 
